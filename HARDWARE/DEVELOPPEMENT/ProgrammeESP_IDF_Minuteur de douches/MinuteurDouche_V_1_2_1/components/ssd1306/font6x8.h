/* ========================================================================== --
   ...
   --------------------------------------------------------------------------
   Fichier d'en-tête contenant la table de caractères ASCII 6x8 (0x20 à 0x7E)
   Utilisée pour l'affichage sur écran graphique type OLED/GLCD.
   Chaque caractère est défini par 6 octets représentant ses colonnes.

   ==========================================================================
   History:
   --------------------------------------------------------------------------
   Date: 2025-06-06 - Authors: Ton Nom / Projet Afficheur ESP32
   + première version
-- ========================================================================== */
#ifndef FONT6X8_H
#define FONT6X8_H
...
/**-------------------------------------------------------------------------- --
   Global constant: table ASCII 6x8
-- -------------------------------------------------------------------------- */
/* -------------------------------------------------------------------------- --
   DESCRIPTION:
   - Table de caractères ASCII de 0x20 (' ') à 0x7E ('~')
   - Chaque caractère est codé sur 6 colonnes (6 octets)
   - Utilisable avec des écrans à base de contrôleur SSD1306
   - L'affichage se fait colonne par colonne, de haut en bas
-- -------------------------------------------------------------------------- */
...
static const uint8_t font6x8[][6] = {
    ...
    {0x00,0x03,0x05,0x00,0x00,0x00}, // 0x60 '`'
